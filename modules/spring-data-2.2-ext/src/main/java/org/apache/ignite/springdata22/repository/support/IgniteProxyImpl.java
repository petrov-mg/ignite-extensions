...
/** Represents proxy for accesiing the Ignite cluster. {@link Ignite} node is used as a delegate. */
public class IgniteProxyImpl implements IgniteProxy {
    /** {@link Ignite} instance that is used as a delegate.*/
    ...
    /** @return The ignite instance to which the current proxy delegates. */
