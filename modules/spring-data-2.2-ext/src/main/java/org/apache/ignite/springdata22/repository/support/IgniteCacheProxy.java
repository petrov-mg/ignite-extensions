...
/** Represents proxy for accessing a Ignite cache. */
public interface IgniteCacheProxy<K, V> extends Iterable<Cache.Entry<K, V>>{
    ...
    /**
     * Gets a collection of entries from the underlying cache, returning them as
    ...
    /**
     * Copies all of the entries from the specified map to the underlying cache.
     *
    ...
    /**
     * Determines if the underlying cache contains an entry for the specified key.
     *
