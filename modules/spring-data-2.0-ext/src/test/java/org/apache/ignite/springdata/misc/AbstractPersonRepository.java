...
public interface AbstractPersonRepository extends IgniteRepository<Person, Integer> {
    ...
    /** Produces a list of domain entity classes whose fields are obtained from the query result for each row. */
    ...
    public List<Person> queryWithIncompelteRowToEntityConversion();
}
