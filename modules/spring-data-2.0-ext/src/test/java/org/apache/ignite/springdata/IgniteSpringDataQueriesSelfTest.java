...
public class IgniteSpringDataQueriesSelfTest extends GridCommonAbstractTest {
    ...
    @Test
    public void testRowToEntityConversion() throws Exception {
     ...
     */
    @Test
    public void testRowToPartitialEntityConversion() throws Exception {
        Set<Person> res = new HashSet<>(repo.queryWithIncompelteRowToEntityConversion());
