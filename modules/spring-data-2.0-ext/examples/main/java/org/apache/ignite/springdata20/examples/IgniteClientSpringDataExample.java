 ...
 * In this example, the thin client instance is started by the user and the corresponding bean name is specified
 * in the Spring Data configuration.
 */
public class IgniteClientSpringDataExample extends SpringDataExample {
    /** {@inheritDoc} */
