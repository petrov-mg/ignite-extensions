...
import static org.apache.ignite.springdata.repository.support.IgniteClientProxy.UNSUPPORTED_ERR_MSG;
...
public class IgniteCacheClientProxy<K, V> implements IgniteCache<K, V> {
    /** {@link ClientCache} instance that is used as a delegate. */
